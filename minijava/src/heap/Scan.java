...
public class Scan implements GlobalConst{
  ...
  //    System.err.println("SCAN: Error in Scan" + e);
	...
	public Tuple getNextInSinglePage(RID rid) throws InvalidTupleSizeException, IOException {
		Tuple recptrtuple = null;
	...
	public boolean loadNextPage() throws InvalidTupleSizeException, IOException {
		return nextDataPage();
	}
