/* File DB.java 
 * Modified by SUHAS to account for reads and writes count*/
...
public class DB implements GlobalConst {
  ...
  public void openDB( String fname, int num_pgs)
    ...
    /* Initializing the counters - SUHAS */
    PCounter.initialize();
  ...
  public  void read_page(PageId pageno, Page apage)
    ...
    try{
      ...
      /* Increasing the reads count */
      PCounter.readIncrement(pageno.pid);
    }
    catch (IOException e) {
  ...
  public void write_page(PageId pageno, Page apage)
    ...
    try{
      ...
      /* Increasing writes count */
      PCounter.writeIncrement(pageno.pid);
    }
    catch (IOException e) {
      throw new FileIOException(e, "DB file I/O error");
    }
