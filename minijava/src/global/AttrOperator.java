...
public class AttrOperator {
  ...
  public String toString() {
	...
	public static AttrOperator findOperator(final String op) throws Exception{
		switch (op) {
		case "=":
			return new AttrOperator(aopEQ);
		case "<":
			return new AttrOperator(aopLT);
		case ">":
			return new AttrOperator(aopGT);
		case "!=":
			return new AttrOperator(aopNE);
		case ">=":
			return new AttrOperator(aopGE);
		case "<=":
			return new AttrOperator(aopLE);
		default:
			throw new Exception("unsupported or invalid operator");
		}
	}

    public static AttrOperator getOppositeOperator(final String op) throws Exception{
        switch (op) {
            case "=":
                return new AttrOperator(aopEQ);
            case "<":
